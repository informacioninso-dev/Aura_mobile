...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)', borderRadius: 14, padding: 14, marginBottom: 16 },
  ...
  qLabel: { color: '#fff', fontSize: 14, fontWeight: '700', marginBottom: 8 },
  ...
  choiceT: { color: '#fff', fontSize: 13.5, fontWeight: '700' },
  ...
  btnSave: { backgroundColor: '#8B5CF6', borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 14 },
  ...
  empty: { color: 'rgba(255,255,255,0.35)', fontSize: 13, textAlign: 'center', paddingVertical: 12 },
  ...
  consumoDesc: { color: '#fff', fontSize: 14, fontWeight: '600' },
  consumoFecha: { color: 'rgba(255,255,255,0.4)', fontSize: 12, marginTop: 1 },
  consumoMonto: { color: '#F87171', fontSize: 15, fontWeight: '700' },
  del: { padding: 6 },
